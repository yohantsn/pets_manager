  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Novo Pet",style: TextStyle(
                      ...
                      children: [
                        Container(
                          ...
                          child: DropdownButton(
                              icon: Icon(Icons.arrow_drop_down, color: Color_Scheme.primaryColor,),
                              hint: Text(
                                "Selecione a especie",
                                style: TextStyle(
                                    fontSize: 14,
                              ...
                              isExpanded: true,
                              items: listEspecies.map((String dropDownStringItem) {
                                return DropdownMenuItem<String>(
                                  value: dropDownStringItem,
                                  child: Text(
                                    dropDownStringItem,
                                    style: TextStyle(
                                        color: Color_Scheme.primaryColor, fontSize: 16),
                                  ),
                                );
                              }).toList(),
